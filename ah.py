...
AHORCADO = ['''
    ...
    =========''', '''
     ...
     / \  |
          |
    =========''']
palabras = 'anillo estrella perro gato caleidoscopio ventilador martillo destornillador pescadero cernicero charcutero españa francia inglaterra luxemburgo alemania higiente termometro sibilino'.split()
...
def elijeLetra(algunaLetra):
    ...
    while True:
        ...
        elif letra not in 'qwertyuiopasdfghjklzxcvbnm':
